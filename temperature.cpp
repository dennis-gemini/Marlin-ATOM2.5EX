...
static int minttemp_raw = ARRAY_BY_EXTRUDERS( HEATER_0_RAW_LO_TEMP , HEATER_1_RAW_LO_TEMP , HEATER_2_RAW_LO_TEMP );
static int maxttemp_raw = ARRAY_BY_EXTRUDERS( HEATER_0_RAW_HI_TEMP , HEATER_1_RAW_HI_TEMP , HEATER_2_RAW_HI_TEMP );
static int minttemp = ARRAY_BY_EXTRUDERS( 0, 0, 0 );
static int maxttemp = ARRAY_BY_EXTRUDERS( 16383, 16383, 16383 );
...
void tp_init()
{
  ...
  while(analog2temp(minttemp_raw, 0) < HEATER_0_MINTEMP) {
  ...
  while(analog2temp(maxttemp_raw, 0) > HEATER_0_MAXTEMP) {
#if HEATER_0_RAW_LO_TEMP < HEATER_0_RAW_HI_TEMP
